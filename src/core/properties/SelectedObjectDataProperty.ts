import { Property, PropertyScope, FabricContext, EditorObjectDataSetKeyCommand, EditorObjectDataSetDataCommand, EditorObjectDataClearCommand, EditorObject } from '../fabric';
